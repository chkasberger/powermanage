...
public class ComPortShell {
	...
	private void createComboPortList(Shell shlPortConfig2) {
		...
		//fd_grpBaudRate.top = new FormAttachment(combo, 29);
		//fd_grpParity.top = new FormAttachment(combo, 29);
	...
	private void createRadioButtonGroups(Shell shlPortConfig2) {
		...
		FormData fd_grpBaudRate;
		fd_grpBaudRate = new FormData();
...
//		fd_grpParity.right = new FormAttachment(grpStopBits, -6);
		...
		fd_grpStopBits.top = new FormAttachment(0, 60);
		fd_grpStopBits.bottom = new FormAttachment(100, -34);
		fd_grpStopBits.left = new FormAttachment(0, 188);
		...
		fd_grpDataBits.top = new FormAttachment(0, 60);
		fd_grpDataBits.bottom = new FormAttachment(100, -34);
